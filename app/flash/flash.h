...
/* 定义FLASH 使用的IO口 */
#define FLASH_CS_SET {GPIOG->BSRR = 0x01 << 13;}//GPIO_SetBits(GPIOG, GPIO_Pin_13)
#define FLASH_CS_CLR {GPIOG->BRR = 0x01 << 13;\
GPIOG->BSRR = 0x01 << 14; GPIOB->BSRR = 0x01 << 12;}
...
#define EN25X_ReadData          0x03   //写数据
